...
def create_book(
    book: BookCreate = Body(..., description="The details of the book to be created", examples={"title": "Example Book", "author": {"name": "John Doe", "bio": "Author bio"}, "pages": 202}),
...
def read_book(
    ...
    return BookInfo(id=book.id, title=book.title, author=AuthorInfo(id=author.id, name=author.name, bio=author.bio), pages=book.pages)
