...
@router.get("/books/random", response_model=List[BookInfo], dependencies=[Depends(RateLimiter(times=5, seconds=60))])
def list_random_books(db: Session = Depends(get_db)):
